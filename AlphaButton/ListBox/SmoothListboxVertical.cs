...
namespace AlphaControls
{
    ...
    /// </summary>
    public delegate void ListItemClickedHandler(SmoothListboxVertical sender, Control listItem, bool isSelected);
    ...
    /// </summary>
    public partial class SmoothListboxVertical : UserControl, IDisposable
    {
        /// <summary>
