...
namespace OrderDish.Common
{
    class CaptureAPI
    {
        ...
        /// <returns></returns>
        public static byte[] GetControlBitmapArray(Control control)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static byte[] GetScreenBitmapArray()
        {
        ...
        public static void DoScreenCaptureTOFile()
        {
            string pathName = "\\My Documents\\";
            string picName = DateTime.Now.ToString("yyyyMMddHHmmss");
            string fileName = string.Empty;
            string pathMsg = "\\My Documents\\"; //数据保存路径
            ...
            byte[] bitmapData = Common.CaptureAPI.GetScreenBitmapArray();
